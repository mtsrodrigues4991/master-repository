...
resource_log_path = testbed_dir+"/resources_log/"
...
def create_topology():
    ...
    dc3 = net.addDatacenter("dc3", resource_log_path=resource_log_path)
    cloud = net.addDatacenter("cloud", resource_log_path=resource_log_path)

    # net.addLink(s4, iperf_server,  bw=1000, delay="0ms")
    net.addLink(s4, dc1, bw=1000, delay="0ms")
    net.addLink(s4, dc2, bw=1000, delay="0ms")
    net.addLink(s4, dc3, bw=1000, delay="0ms")
    net.addLink(s4, cloud)
