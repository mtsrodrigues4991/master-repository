...
def create_topology(args):
    ...
    # Adding cars (nodes) and set the first IP address from 11.0.0.10. This is the 5G emulated link
    # Other cars' IP addresses will be set by incrementing the previous one
    ...
    info("**** Launching UE\n")
    # This loop over all cars and starts a python script "car_start_script.py"
    # car_start_script.py launches commands to check wifi connectivity and force it
